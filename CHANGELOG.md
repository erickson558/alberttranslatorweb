...
- Verificado con prueba en navegador real (Chromium headless): tras hacer clic en "Iniciar escucha", el botón "Detener" se habilita de inmediato; al hacer clic en "Detener" durante la fase de arranque, la app vuelve a estado "Inactivo" limpio (botones correctos) sin quedar colgada. `node tests/transcription_engine_merge_cases.js` sigue en verde.

### Changed
- Versión sincronizada a V1.6.5 en VERSION, APP_VERSION, README y CHANGELOG.
