/*
  Regresion de commit multilinea de reconocimiento.
  Cuando Web Speech entrega varias frases en un mismo bloque final/interim,
  deben preservarse por linea al comprometerse y al mostrarse en vivo.
*/
...
function mergeTranscriptBlockIntoText(baseText, chunkText) {
  ...
  if (!chunkLines.length) {
    return { text: merged, changed: false };
  }
...
const cases = [
  {
    base: "",
    block: "hi are you traveling\nyes I am",
    expected: "hi are you traveling\nyes I am",
  },
  {
    base: "hi are you traveling\nyes I am",
    block: "I am going on vacation\nthat sounds exciting",
    expected: "hi are you traveling\nyes I am\nI am going on vacation\nthat sounds exciting",
  },
  {
    base: "the meal",
    block: "that sounds delicious\nhow did you order it",
...
for (let i = 0; i < cases.length; i += 1) {
  ...
  const got = mergeTranscriptBlockIntoText(current.base, current.block).text;
...
console.log("[OK] recognition multiline commit cases");
